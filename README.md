# MEALMATE Web - Application Mobile de Gestion du Diabète

Une application web responsive conçue pour les personnes diabétiques, les médecins et les administrateurs dans le domaine de la gestion du diabète.
...
### 🏥 Gestion Médicale
- **Dossiers diabétiques** complets
- **Suivi des rendez-vous** médicaux
- **Paramètres médicaux** (glycémie, tension, HbA1c, etc.)
- **Symptômes et médicaments** tracking
- **Nutrition personnalisée** avec objectifs
- **Examens et analyses** réguliers
